...
from great_dataset_t import GReaTDataset, GReaTDataCollator
...
from great_trainer_t import GReaTTrainer
...
class GReaT:
    ...
    def __init__(
        ...
        **train_kwargs,
        ...
        # self.tokenizer = AutoTokenizer.from_pretrained(self.llm,quantization_config=bnb_config,device_map="auto",trust_remote_code=True,)
        # self.tokenizer.pad_token = self.tokenizer.eos_token
        self.tokenizer = AutoTokenizer.from_pretrained(self.llm)
        self.tokenizer.pad_token = self.tokenizer.eos_token
        self.model = AutoModelForCausalLM.from_pretrained(self.llm,quantization_config=bnb_config,device_map="auto",trust_remote_code=True,)
    ...
    def fit(
        ...
        # bnb_config = BitsAndBytesConfig(load_in_4bit= True,bnb_4bit_quant_type= "nf4",bnb_4bit_compute_dtype= torch.float16,bnb_4bit_use_double_quant= True,lm_int8_enable_fp32_cpu_offload= True)

        # great_trainer = GReaTTrainer(
        #     self.model,
        #     training_args,
        #     train_dataset=great_ds,
        #     tokenizer= AutoTokenizer.from_pretrained(self.llm,quantization_config=bnb_config,device_map="auto",trust_remote_code=True,),
        #     data_collator=GReaTDataCollator(self.tokenizer),
        # )

        # from transformers import Trainer
        # great_trainer = Trainer(
        #     self.model,
        #     training_args,
        #     train_dataset=great_ds,
        #     tokenizer= AutoTokenizer.from_pretrained(self.llm,quantization_config=bnb_config,device_map="auto",trust_remote_code=True,),
